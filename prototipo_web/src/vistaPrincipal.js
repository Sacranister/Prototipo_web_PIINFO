...
export default class VistaPrincipal extends Component{
  ...
  agendar(){
    this.props.cambiarAgendarCaro(true);
          ...
          <Card style={{ width: '100%' }}>
            <Row>
              ...
              <Col span={8}>
                ...
                <div><Button style={{}}>Perfil</Button><Button onClick={this.agendar} style={{float: 'right'}}>Agendar</Button></div>
